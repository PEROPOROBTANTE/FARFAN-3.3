...
class OrchestratorConfig:
    ...
    cuestionario_path: Path = base_dir / "data" / "raw" / "cuestionario.json"
    rubric_path: Path = base_dir / "data" / "raw" / "rubric_scoring.json"
    ...
    modules: Dict[str, ModuleConfig] = field(default_factory=lambda: {
        "analyzer_one": ModuleConfig(
            name="Analyzer One",
            file_path=Path("domain/Analyzer_one.py"),
        ...
        "causal_processor": ModuleConfig(
            ...
            file_path=Path("domain/causal_proccesor.py"),
        ...
        "contradiction_detector": ModuleConfig(
            ...
            file_path=Path("domain/contradiction_deteccion.py"),
        ...
        "dereck_beach": ModuleConfig(
            ...
            file_path=Path("domain/dereck_beach"),
        ...
        "embedding_policy": ModuleConfig(
            ...
            file_path=Path("domain/emebedding_policy.py"),
        ...
        "financial_viability": ModuleConfig(
            ...
            file_path=Path("domain/financiero_viabilidad_tablas.py"),
        ...
        "policy_processor": ModuleConfig(
            ...
            file_path=Path("domain/policy_processor.py"),
        ...
        "policy_segmenter": ModuleConfig(
            ...
            file_path=Path("domain/policy_segmenter.py"),
