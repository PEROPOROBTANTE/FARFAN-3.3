...
class TestCORSConfiguration:
    ...
    @patch.dict(os.environ, {"ALLOWED_ORIGINS": "https://example.com,https://api.example.com"})
...
class TestRateLimiter:
    ...
    def test_rate_limiter_has_defaults(self):
        ...
        limits = getattr(limiter, 'default_limits', None) or getattr(limiter, '_default_limits', [])
        assert len(limits) > 0
...
class TestSecurityConfiguration:
    ...
    def test_production_environment(self):
        ...
        assert security_module.IS_PRODUCTION or security_module.ENVIRONMENT == "production"
